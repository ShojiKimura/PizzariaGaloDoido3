...
Para clonar este repositório localmente, copie e cole o comando abaixo no seu terminal:

```bash
git clone https://github.com/ShojiKimura/PizzariaGaloDoido3.git
```

Depois entre na pasta do projeto adequada (ex.: `Pizzaria0.2`) antes de instalar dependências ou executar scripts.
```markdown
